...
import { isToday as isTodayFn } from '../schedule-utils';
import { useNowSeconds } from '@/hooks/useNowSeconds';
import type { AiringAnime } from '@shiroani/shared';
import type { IDailyViewView, IHourBlock, IHourMark } from './DailyView.types';

// ─── Layout constants ─────────────────────────────────────────────
/** Pixel height of an empty hour row (no episode airs). */
export const HOUR_HEIGHT_BASE = 56;
...
/**
 * Adaptive vertical hour-axis timeline state for a single day.
 *
 * Layout algorithm:
