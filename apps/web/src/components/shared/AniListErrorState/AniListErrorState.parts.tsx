...
const ERROR_GLOW =
  'radial-gradient(circle at 50% 50%, oklch(from var(--destructive) l c h / 0.22), transparent 60%)';
    ...
    <PreviewStage height={140} border="bottom" glow={ERROR_GLOW}>
      <div className="absolute inset-0 grid place-items-center">
        <div className="relative size-20">
          ...
          />
          <div className="absolute inset-0 grid place-items-center">
            <div className="size-14 rounded-full bg-destructive/20 border border-destructive/40 grid place-items-center shadow-[0_8px_24px_oklch(from_var(--destructive)_l_c_h/0.25)]">
