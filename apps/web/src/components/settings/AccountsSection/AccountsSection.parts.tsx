...
/**
 * MyAnimeList connect/disconnect card. Mirrors the AniList card in the shell but
 * reads its own {@link useMalAuthStore} (independent connection + error state).
 *
 ...
 */
export function MalAccountCard() {
 ...
 */
export function AniListSyncCard() {
  const { t, i18n } = useTranslation('accounts');
