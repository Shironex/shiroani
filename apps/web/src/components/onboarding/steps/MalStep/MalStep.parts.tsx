...
interface IMalAccountCardProps {
  connected: boolean;
  viewer?: MalViewer;
  loading: boolean;
...
/**
 * The MyAnimeList connection card: connected viewer (avatar + name) or a connect
